	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		try (Scanner leia = new Scanner(System.in)) {
			do {
				...
				System.out.println("[3] - Lançar notas de uma disciplina.");
				System.out.println("[4] - Alterar a nota de um alune específico.");
				System.out.println("[5] - Listar todas as notas dos alunes.");
				System.out.println("[6] - Listar todas as notas das disciplinas.");
				...
				switch(op){
					...
					case '4'://Alterar nota de um aluno especifico
						...
						leia.nextLine();
						System.out.println("Insira o Nome ou RA do estudante.");
						String identificacao1 = leia.nextLine();
